...
namespace GCommon.Primitives.Abstractions
{
    public abstract class ObjectBase : IXSerializable, IDifferentiable<ObjectBase>
    {
        ...
        protected ObjectBase(XElement element)
        {
            ...
            Template.SetPrimitives(element.Descendants(nameof(Template.Primitives))
                .Select(ArchestraAttribute.Materialize));
        }
        ...
        public virtual XElement Serialize()
        {
            ...
            if (Template.Primitives != null)
                root.Add(new XElement(nameof(Template.Primitives), Template.Primitives.Select(a => a.Serialize())));
